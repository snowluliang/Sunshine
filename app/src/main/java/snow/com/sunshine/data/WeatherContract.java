 ...
 */
package snow.com.sunshine.data;
...
public class WeatherContract {
    ...
    public static final String CONTENT_AUTHORITY = "snow.com.sunshine";
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        public static Uri buildWeatherLocationWithDate(String locationQuery, long testDate) {
            ...
            return CONTENT_URI.buildUpon().appendPath(locationQuery)
                    .appendPath(Long.toString(normalizeDate(testDate))).build();
        }
